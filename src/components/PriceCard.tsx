    ...
    <Card className="w-full max-w-sm">
      <CardHeader>
        ...
        <div className="flex items-center space-x-2">
          ...
          {hasChange && (
            <div className={`flex items-center space-x-1 text-sm ${isPositive ? 'text-green-600' : isNegative ? 'text-red-600' : 'text-gray-600'
              }`}>
      ...
      <CardContent>
        ...
        {hasChange && (
          <div className={`text-sm ${isPositive ? 'text-green-600' : isNegative ? 'text-red-600' : 'text-gray-600'
            }`}>
